...
Original file is located at
    https://colab.research.google.com/drive/1HodF7RuKO0ICW6u_H-klaltRkm0izjcW
"""
...
def crossover(individual1, individual2, crossover_rate=0.01):
...
# Nhiều bài toán lớn, số generation lên tới vài ngàn vòng. In ra từng generation thì nhiều và rối; lúc đó bạn cho thể gán gen%50 == 0
    new_population = []
